...
def llenar_tablero(tablero, nivel=1):
    ...
    for i in range(0,nivel):
        ...
        fila_generada = fila_generada+1
        columna_generada =columna_generada+1
...
def modificar_posicion(fila,columna,tablero):
    ...
    columna = columna+1
    #Posicion central
    comprobar_posicion(tablero,fila,columna)
    #Cuadrado superior
    cuadrado(fila-2,columna+1,tablero)
    #Cuadrado central
    cuadrado(fila,columna-2,tablero)
    #Cuadrado inferior
    cuadrado(fila+1,columna+1,tablero)
        
def cuadrado(fila, columna, tablero):
    comprobar_posicion(tablero,fila,columna)
    comprobar_posicion(tablero,fila+1,columna)
    comprobar_posicion(tablero,fila,columna+1)
    comprobar_posicion(tablero,fila+1,columna+1)
